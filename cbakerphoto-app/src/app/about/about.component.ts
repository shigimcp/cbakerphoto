...
// import { UserAgentInfoRx } from 'ngx-responsive';
...
// export class AboutComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.responsiveService._subscribe();
    }


    // userAgentData2 = this.responsiveService.thisUserAgent(userAgent: UserAgentInfoRx);
    ...
    // public thisUserAgent(userAgent: UserAgentInfoRx) {
